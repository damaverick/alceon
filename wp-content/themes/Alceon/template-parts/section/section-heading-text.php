...
<section class="<?php echo esc_attr($bg_class); ?> section--<?php echo esc_attr($bg_class); ?> pb-5 border-top-0">
    <div class="container">
        <div class="row d-flex justify-content-between align-items-start mb-5">

            <?php if ($ht_heading) : ?>
                <div class="<?php echo esc_attr($heading_col_class); ?>">
