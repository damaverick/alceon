 ...
 * Uses get_field for Flexible Content contexts
 */

// 1. Get ACF Fields
$type     = strtolower( (string) get_field( 'image_or_video_background' ) );
$is_video = str_contains( $type, 'video' );

$img_array  = get_field( 'full_width_image' ); // Array
$video_url  = get_field( 'full_width_video' );
$img_poster = get_field( 'full_width_video_poster_image' ); // Array
