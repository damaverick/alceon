...
$cta_heading = trim((string) get_field('call_to_action_heading'));
$cta_text    = trim((string) get_field('call_to_action_text'));
$cta_btn_txt = trim((string) get_field('call_to_action__button_text_'));

// Link field can be array (Link) or string (back-compat if you used URL before)
$link = get_field('call_to_action_url');
$cta_url    = '';
$cta_target = '';
...
<section class="section--cta section--gradient-purple text-white mb-0">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 align-items-start justify-content-end d-flex">
                <?php if ($cta_url): ?>
                    <a href="<?php echo $cta_url; ?>" class="btn pill btn-outline-white" <?php echo $cta_target; ?>>
