...
<script>
  ...
  const totalItems = <?php echo intval($total_cards); ?>;
  // This helps hide arrows, but doesn't stop the dragging logic by itself
  ...
  jQuery(document).ready(function($) {
      ...
      $("#talentCommunity").owlCarousel({
        ...
        responsive: {
          ...
          1080: {
            ...
            nav: true,
            dots: true,
            mouseDrag: false, // Prevents sliding when clicking/dragging with mouse
            touchDrag: false, // Prevents sliding on touch screens (if desired)
            pullDrag: false, // Prevents the "rubber band" effect at the edges
            freeDrag: false // Ensures items snap to grid
          }
          // -----------------------------
        },
    ...
    function wrapOwlControls(event) {
      ...
      var showControls = controlsEnabled();
