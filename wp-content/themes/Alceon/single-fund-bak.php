...
{inside_portfolio_text}

{how_the_fund_works_text}
...
<?php if (get_row_layout() == 'resources'): ?>
    ...
    <section class="section--icon-widgets pt-4 ">
        <div class="container">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="icon-widget <?php echo esc_attr($current_class); ?>">
                            ...
                            <?php else: // Otherwise, use the default shield icon ?>
                                <div class="icon-widget__icon">
                                    <img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/img/svg/doc.svg' ); ?>" alt="">
                                </div>
